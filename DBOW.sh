...
models=('-cbow 0 -sample 3e-1' '-cbow 0 -sample 3e-2' '-cbow 0 -sample 3e-3' '-cbow 0 -sample 1e-3' '-cbow 0 -sample 1e-2' '-cbow 0 -sample 1e-1')
default_parameters=('-size 150 -alpha 0.05 -window 10 -negative 25 -iter 25 -threads 1 -min_count 1 -train alldata-id.txt')
default_models=('-cbow 0 -sample 1e-2')
mkdir time_p2v
time_fold="time_p2v/"
mkdir space_p2v
