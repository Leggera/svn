...
default_models1=('-cbow 1 -sample 1e-4 -alpha 0.07' '-cbow 1 -sample 1e-4 -alpha 0.2' '-cbow 1 -sample 1e-4 -alpha 0.6'
 '-cbow 0 -sample 1e-2 -alpha 0.05' '-cbow 0 -sample 1e-2 -alpha 0.15'
'-cbow 0 -sample 1e-2 -alpha 0.03' '-cbow 0 -sample 1e-2 -alpha 0.09' '-cbow 0 -sample 1e-2 -alpha 0.27')
default_models2=('-cbow 0 -sample 1e-2 -alpha 0.017' '-cbow 0 -sample 1e-2 -alpha 0.007' '-cbow 0 -sample 1e-2 -alpha 0.02'
'-cbow 0 -sample 1e-2 -alpha 0.06' '-cbow 1 -sample 1e-4 -alpha 0.00005' '-cbow 1 -sample 1e-4 -alpha 0.0001' 
